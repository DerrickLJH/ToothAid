...
<html>
        ...
        <script type="text/javascript">
             $(document).ready(function () {
                 ...
                 var marker = new google.maps.Marker({
                     position: {lat: 1.33815, lng: 103.7075},
                     map: map,
                     title: "I love Republic Polytechnic!"
                 });
                 ...
                 google.maps.event.addListener(marker, 'click', function (event) {
                     var infowindow = new google.maps.InfoWindow({
                         content: "Click <a href=http://www.rp.edu.sg>here</a> for more information"
                     });
    ...
    <body>
        ...
        <h4 style="margin: 25px; text-align: center">Choa Chu Kang Dental Clinic</h3>
